...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 16,
        "participants": ["ethan@mergington.edu", "nina@mergington.edu"]
    },
    "Soccer Team": {
    ...
    "Robotics Workshop": {
        "description": "Build and program robots for hands-on STEM learning",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 12,
        "participants": ["logan@mergington.edu", "bella@mergington.edu"]
    }
}
...
def unregister_from_activity(activity: str = Query(...), email: str = Query(...)):
